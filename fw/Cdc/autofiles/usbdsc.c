...
const_rom unsigned char *rom USB_CD_Ptr[]=
{
	(const_rom unsigned char *) &cfg01,
	(const_rom unsigned char *) &cfg01
};

const_rom unsigned char *rom USB_SD_Ptr[]=
{
	(const_rom unsigned char *) &sd000,
	(const_rom unsigned char *) &sd001,
	(const_rom unsigned char *) &sd002
};
