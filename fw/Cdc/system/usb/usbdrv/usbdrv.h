...
{                                                                           \
    buffer_dsc.a.Stat._byte &= _DTSMASK;          /* Save only DTS bit */     \
    buffer_dsc.a.Stat.a.DTS = !buffer_dsc.a.Stat.a.DTS; /* Toggle DTS bit    */     \
    buffer_dsc.a.Stat._byte |= _USIE|_DTSEN;      /* Turn ownership to SIE */ \
}
